...
class SLBDriver(Driver):
    ...
    def create_balancer(self, name, port, protocol, algorithm, members,
                        ...
                        ex_main_zone_id=None, ex_subordinate_zone_id=None,
        ...
        :keyword ex_main_zone_id: The id of the main availability zone
        :type ex_main_zone_id: ``str``

        :keyword ex_subordinate_zone_id: The id of the subordinate availability zone
        :type ex_subordinate_zone_id: ``str``
        ...
        if ex_main_zone_id:
            params['MainZoneId'] = ex_main_zone_id
        if ex_subordinate_zone_id:
            params['SubordinateZoneId'] = ex_subordinate_zone_id
